...
GS_RES_LIST=("1")
CAM_DISTANCE_LIST=("1")
DEGREE_LIST=("15" "30" "45" "60" "75")
# DEGREE_LIST=("0" "15" "30" "45" "60" "75")
...
for GS_RES in "${GS_RES_LIST[@]}"; do
    for CAM_DISTANCE in "${CAM_DISTANCE_LIST[@]}"; do
        for DEGREE in "${DEGREE_LIST[@]}"; do
            ...
            RESULTS_NAME="ours_deg${DEGREE}_${CAM_DISTANCE}x_factor${RENDER_FACTOR}"
            OUR_CAM_PATH="${OUR_CAM_BASE_DIR}/${SCENE_NAME}/results_circle_deg${DEGREE}_${CAM_DISTANCE}x/transforms.json"
            ...
            python ./metrics.py \
                ...
                --mask_dir "${OUR_CAM_BASE_DIR}/${SCENE_NAME}/results_circle_deg${DEGREE}_${CAM_DISTANCE}x/mask"
