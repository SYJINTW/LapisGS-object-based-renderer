...
# ======= Config ======
SCENE_NAME="materials" #! Change to your scene name ("lego", "materials")
...
GT_DIR="${OUTPUT_DATA_BASE_DIR}/${SCENE_NAME}/opacity/${SCENE_NAME}_res1/ours_1x_factor1/ours_30000/renders"
...
for GS_RES in "${GS_RES_LIST[@]}"; do
    for CAM_DISTANCE in "${CAM_DISTANCE_LIST[@]}"; do
        ...
        RESULTS_NAME="ours_${CAM_DISTANCE}x_factor${RENDER_FACTOR}"
        OUR_CAM_PATH="${OUR_CAM_BASE_DIR}/${SCENE_NAME}/results_test_${CAM_DISTANCE}x/transforms.json"
        ...
        python ./metrics-lapisgs-exp.py \
            ...
            --gt_dir "${GT_DIR}" \
            --mask_dir "${OUR_CAM_BASE_DIR}/${SCENE_NAME}/results_test_${CAM_DISTANCE}x/mask" \
